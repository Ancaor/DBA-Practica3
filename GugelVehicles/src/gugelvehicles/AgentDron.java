 ...
 * @author Anton
 */
public class AgentDron extends Agent{
...
/*
    ...
    private void wait_controller() {
       ...
       // System.out.println(reply_with_controller);
        ...
        if(performativa.equals("REQUEST") && content.contains("checkin")){
            System.out.println(ANSI_GREEN + "Controlador solicita su suscripción");
    ...
    private void wait_server_chekin() {
        ...
        if(performativa.equals("INFORM") && content.contains("OK")){
            System.out.println(ANSI_GREEN + "Checkin realizado con exito");
            ...
            boolean isVehicleType = checkTipoVechivulo(VehicleType.DRON,capabilities.get("fuelrate"));
            ...
            if(isVehicleType){
                ...
                System.out.println(ANSI_GREEN+ "SI es un dron");
                ...
                System.out.println(ANSI_GREEN+ "NO es un dron");
